                                                            ...
                                                            <div class="widget widget_nav_menu kc-elm kc-css-1908114">
                                                                <div class="menu-pages-menu-1-container">
                                                                    <ul id="menu-pages-menu-5" class="menu">
                                                                        {{--<li class="nav-title menu-item"><a href="{{route('products')}}">Shop</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="{{route('products')}}">Pizza</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="{{route('products')}}">Burgers</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="{{route('products')}}">Tacos</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="{{route('products')}}">Shawarma</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="{{route('products')}}">Fries</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="{{route('products')}}">Salads</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="{{route('products')}}">Drinks</a></li>--}}
                                                                        <li class="nav-title menu-item"><a href="#">User Account</a></li>
                                                                        <li class="menu-item"><a href="{{route('login-and-register')}}">My Account</a></li>
                                                                        <li class="menu-item"><a href="{{route('track-order')}}">Track Order</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="widget widget_nav_menu kc-elm kc-css-3447423">
                                                                <div class="menu-pages-menu-4-container">
                                                                    <ul id="menu-pages-menu-8" class="menu">
                                                                        ...
                                                                        <li class="nav-title menu-item"><a href="{{route('blog')}}">Blog</a></li>
                ...
                <div class="handheld-navigation">
                    ...
                    <ul  class="menu">
                        @foreach($menus->getMenus() as $menu)
                            <li class="menu-item"><a href="{{route('products', $menu->key)}}"><i class="{{$menu->icon}}"></i>{{$menu->name}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </nav>
